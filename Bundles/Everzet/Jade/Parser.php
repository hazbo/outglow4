...
class Parser
{
     ...
     */
    public function __construct(Lexer_LexerInterface $lexer)
    {
        $this->lexer = $lexer;
    }
    ...
    public function parse($input)
    {
        ...
        $node = new Node_BlockNode($this->lexer->getCurrentLine());
    ...
    protected function parseText($trim = false)
    {
        ...
        return new Node_TextNode($value, $this->lexer->getCurrentLine());
    }
    ...
    protected function parseCode()
    {
        ...
        $node   = new Node_CodeNode($token->value, $token->buffer, $this->lexer->getCurrentLine());
    ...
    protected function parseComment()
    {
        ...
        $node   = new Node_CommentNode(preg_replace('/^ +| +$/', '', $token->value), $token->buffer, $this->lexer->getCurrentLine());
    ...
    protected function parseDoctype()
    {
        ...
        return new Node_DoctypeNode($token->value, $this->lexer->getCurrentLine());
    }
    ...
    {
        $node = new Node_TextNode(null, $this->lexer->getCurrentLine());
    ...
    protected function parseTag()
    {
        ...
        $node = new Node_TagNode($name, $this->lexer->getCurrentLine());
        ...
        if ('text' === $this->lexer->predictToken()->type) {
            if ($text = $node->getText()) {
                ...
                $node->setText(new Node_TextNode('', $this->lexer->getCurrentLine()));
            }
        }
